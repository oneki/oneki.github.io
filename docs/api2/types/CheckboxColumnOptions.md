---
id: CheckboxColumnOptions
title: CheckboxColumnOptions
sidebar_label: CheckboxColumnOptions
---

```tsx
__type(options: CheckboxColumnOptions<T, I>): React.FC<TableBodyCellProps<T, I>>
```
<br/>
