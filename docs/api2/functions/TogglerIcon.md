...
id: TogglerIcon
title: TogglerIcon
sidebar_label: TogglerIcon
---

```tsx
TogglerIcon(props: ): ReactElement<WithOptionalTheme<
TogglerIcon<AsC,FAsC>(props: StyledComponentPropsWithAs<AsC, any, , never, AsC, FAsC>): ReactElement<StyledComponentPropsWithAs<AsC, any, , never, AsC, FAsC>, string | JSXElementConstructor<any>>
```
<br/>
