...
```tsx
Col(props: ): ReactElement<WithOptionalTheme<
Col<AsC,FAsC>(props: StyledComponentPropsWithAs<AsC, any, , never, AsC, FAsC>): ReactElement<StyledComponentPropsWithAs<AsC, any, , never, AsC, FAsC>, string | JSXElementConstructor<any>>
```
<br/>
...
| xs | [GridSize](/api2/types/GridSize.md)Partial<\>, any\>, string \| JSXElementConstructor<any\>\> |  |
| xs | GridSize |  |
| xs | GridSizePartial<\>, any\>, string \| JSXElementConstructor<any\>\> |  |
