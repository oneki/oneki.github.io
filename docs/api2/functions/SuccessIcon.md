...
id: SuccessIcon
title: SuccessIcon
sidebar_label: SuccessIcon
---

```tsx
SuccessIcon(props: ): ReactElement<WithOptionalTheme<
SuccessIcon<AsC,FAsC>(props: StyledComponentPropsWithAs<AsC, any, , never, AsC, FAsC>): ReactElement<StyledComponentPropsWithAs<AsC, any, , never, AsC, FAsC>, string | JSXElementConstructor<any>>
```
<br/>
