---
id: DashboardOverlay
title: DashboardOverlay
sidebar_label: DashboardOverlay
---

```tsx
DashboardOverlay(props: ): ReactElement<WithOptionalTheme<
DashboardOverlay<AsC,FAsC>(props: StyledComponentPropsWithAs<AsC, any, , never, AsC, FAsC>): ReactElement<StyledComponentPropsWithAs<AsC, any, , never, AsC, FAsC>, string | JSXElementConstructor<any>>
```
<br/>
